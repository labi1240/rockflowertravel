  ...
  return (
    <aside className="relative flex flex-col justify-between gap-8 overflow-hidden border-t border-mist-200 bg-mist-100 p-6 text-mist-900 sm:border-l sm:border-t-0 sm:p-9">
      ...
      <div className="relative space-y-6">
        ...
        <div className="flex items-start gap-2.5 rounded-xl border-l-[3px] border-l-red-400 bg-red-50 px-3 py-2.5">
          <svg aria-hidden viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mt-px size-3.5 shrink-0 text-red-600"><path d="M12 9v4M12 17h.01M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z" /></svg>
          <p className="text-[11px] leading-snug text-mist-700">
            <strong className="text-mist-900">No parking at the lakes.</strong> Parks Canada permits
            no customer parking at its lots, day-use areas, or trailheads — plan parking ahead; we
            can&apos;t provide it.
          </p>
        </div>
      </div>
